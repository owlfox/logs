 ...
 *           particle t
 *
 * Compile:  nvcc -o nbody_basic nbody_basic.cu stats.c set_device.c
 ...
 *           Default floating point type is REAL.  To get float, define
 *              FLOAT
 ...
 *      2     1024      2048   2.89e-3
 *                             2.82e-1 serial
 *     32     1024    32,768   7.34e-2
 *                             5.07e+1 serial
 *     64     1024    65,536   2.94e-1
 *                             
 *    256     1024   262,144   2.24e+0 
 *                             
 *    1024    1024 1,048,576   4.81e+1
 *                             
 * IPP2:   7.1.12 (pp. 390 and ff.)
 */
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
